...
import com.ceva.batch.split.jaxb.cwo.Date;
import com.datastax.driver.mapping.annotations.PartitionKey;
import com.datastax.driver.mapping.annotations.Table;


/**
 * EmployerDetails Table.
 * @author shaik.
 *
 */
...
public class EmployerDetails {
  ...
  public EmployerDetails(int employerSno, String previousCompanyName, String previousCompanyAdrress,
      ...
      java.util.Date previousEmploymentPeriodFrom, java.util.Date previousEmploymentPeriodTo, String previousEmpId,
      String leavingReason, String leaveMode, String lastSalary, String paySlips, String form16,
      String relievingLetter, String appointmentLetter, String empId) {
    super();
