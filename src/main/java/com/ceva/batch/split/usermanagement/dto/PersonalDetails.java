...
public class PersonalDetails {
  ...
  public PersonalDetails(int employeeId, String primarySkill, String birthPlace, String fatherName,
      ...
      java.util.Date presentAddressFromDate, java.util.Date permanentAddressFromDate,
      java.util.Date presentAddressToDate, java.util.Date permanentAddressToDate, String title,
      String natiionality, String maidenName, String motherName, java.util.Date dob,
