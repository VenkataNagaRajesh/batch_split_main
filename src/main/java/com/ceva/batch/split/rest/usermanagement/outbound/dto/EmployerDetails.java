...
/**
 * EmployerDetails object2 Entity.
 * 
 * @author shaik
 *
 */
...
public class EmployerDetails {
  ...
  LocalDate previousEmploymentPeriodFrom;
  LocalDate previousEmploymentPeriodTo;
   ...
   * 
   */
  public EmployerDetails(int employerSno, String previousCompanyName, String previousCompanyAdrress,
      String previousEmpType, String previousEmpDesignation, String reportingPersonName,
      String repostingPersonPosition, String reportingPersonContact,
      LocalDate previousEmploymentPeriodFrom, LocalDate previousEmploymentPeriodTo,
  ...
  public LocalDate getPreviousEmploymentPeriodFrom() {
    return previousEmploymentPeriodFrom;
  }

  public void setPreviousEmploymentPeriodFrom(LocalDate previousEmploymentPeriodFrom) {
    this.previousEmploymentPeriodFrom = previousEmploymentPeriodFrom;
  }

  public LocalDate getPreviousEmploymentPeriodTo() {
    return previousEmploymentPeriodTo;
  }

  public void setPreviousEmploymentPeriodTo(LocalDate previousEmploymentPeriodTo) {
    this.previousEmploymentPeriodTo = previousEmploymentPeriodTo;
  }
  ...
  public String toString() {
    return "EmployerDetails [employerSno=" + employerSno + ", previousCompanyName="
