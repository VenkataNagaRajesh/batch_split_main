...
public class GlobalExceptionHandler {
  ...
  /**
   * invalid input. ex exception. request request. response.
   */
  @ExceptionHandler(InvalidInputException.class)
  public ResponseEntity<String> notValid(InvalidInputException invalidinput) {
    return new ResponseEntity<>(invalidinput.getMessage(),HttpStatus.BAD_GATEWAY);
  }
