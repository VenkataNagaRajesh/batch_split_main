...
public class RestClientUtil {
  ...
  private Map.Entry<Integer, String> postRequest(String request, String contentType, String charset)
    ...
    try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
      ...
      String correlationId = BatchSplitLoggerUtils.getCorrelationId();
      if (correlationId != null) {
        httpPost.setHeader(BatchSplitLoggerUtils.REQUEST_ID, correlationId);
      } 
  ...
  private Map.Entry<Integer, String> getRequest() throws IOException, URISyntaxException {
    ...
    try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
      ...
      String correlationId = BatchSplitLoggerUtils.getCorrelationId();
      if (correlationId != null) {
        httpGet.setHeader(BatchSplitLoggerUtils.REQUEST_ID, correlationId);
      }
      HttpResponse httpResponse = null;
      HttpEntity responseEntity = null;
