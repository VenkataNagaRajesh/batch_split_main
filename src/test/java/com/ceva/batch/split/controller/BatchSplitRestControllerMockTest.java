package com.ceva.batch.split.controller;
...
/**
 * BatchSplitRestControllerMockTest.
 * 
 * @author narayana
 *
 */
...
public class BatchSplitRestControllerMockTest {
  /*
   * 
   * 
   ...
   * mockMvc.perform(post("/batch-split").andReturn() .getResponse();
   * verify(brokerageService, times(1)).processBrokerageServiceInbound(jobNumber, "BOOKING", new
